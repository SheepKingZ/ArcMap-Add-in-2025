...
namespace ForestResourcePlugin.Utils
{
    ...
    public static class CountyCodeMapper
    {
        ...
        private static readonly Dictionary<string, string> CountyCodeMap = new Dictionary<string, string>
        {
            ...
            { "仁化县", "440224" },//
            { "翁源县", "440229" },//
            { "乳源瑶族自治县", "440232" },//错误4：乳源县->乳源瑶族自治县
            { "新丰县", "440233" },//
            { "乐昌市", "440281" },//
            { "南雄市", "440282" },//
            ...
            { "龙岗区", "440307" },//
            { "盐田区", "440308" },//
            { "龙华区", "440309" },//错误5：龙华新区——>龙华区
            { "坪山区", "440310" },//错误6：坪山新区——>坪山区
            { "光明区", "440311" },//错误7:光明新区——>光明区
            ...
            // 茂名市
            { "茂南区", "440902" },//
            //{ "茂港区", "440903" }错误2：多了个茂港区
            { "电白区", "440904" },//
            { "高州市", "440981" },//
            { "化州市", "440982" },//
            { "信宜市", "440983" },//错误3：少了信宜市
            ...
            { "佛冈县", "441821" },//
            { "阳山县", "441823" },//
            { "连山壮族瑶族自治县", "441825" },//错误11：连山县->连山壮族瑶族自治县
            { "连南瑶族自治县", "441826" },//错误12：连南县->连南瑶族自治县
            { "英德市", "441881" },//
            { "连州市", "441882" },//

            // 东莞市 - 特殊处理，东莞市没有县级行政区划代码，错误1
            { "东莞市", "441900" },//
            ...
            // 云浮市
            { "云城区", "445302" },//
            { "云安区", "445303" },//错误9：云安县->云安区
            { "新兴县", "445321" },//
            { "郁南县", "445322" },//
            { "罗定市", "445381" },//

            //中山市 - 特殊处理，中山市没有县级行政区划代码，错误13，少了中山市
            { "中山市", "442000" },
        };
